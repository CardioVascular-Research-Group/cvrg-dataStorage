...
public abstract class Connection {
	...
	public abstract Long storeDocument(long userID, String recordName, String subjectID, int originalFormat, double samplingRate, String fileTreePath, int leadCount, int numPoints, Calendar dateUploaded, int age, String gender, Calendar dateRecorded, double aduGain, long[] filesId, String leadNames, long timeseriesId) throws DataStorageException;
	...
	public abstract boolean storeFilesInfo(long documentRecordId, long[] fileEntryId, Long analysisJobId, Long timeseriesId) throws DataStorageException;
