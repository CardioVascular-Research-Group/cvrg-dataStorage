 ...
 *
 */
public class AdditionalParametersDTO implements Serializable{

	private static final long serialVersionUID = -1000936560883026122L;
	...
	* https://bitbucket.org/galaxy/galaxy-central/src/tip/lib/galaxy/tools/parameters/basic.py  */
	...
	private ParameterValidatorDTO validator; 
	/** list of options; only valid when type is "select" or "drill_down" */
	private ParameterOptionDTO aOptionList[];
	...
	public ParameterValidatorDTO getValidator() {
		return validator;
	}
	public void setValidator(ParameterValidatorDTO validator) {
		this.validator = validator;
	}
	public ParameterOptionDTO[] getOptionList() {
		return aOptionList;
	}
	public void setOptionList(ParameterOptionDTO[] aOptionList) {
